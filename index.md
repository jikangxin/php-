	...
	<div id="mybody">
    	<div id="top">
        	<div class="menu">
            	<ul>
                	<li>网站首页</li>
                   {pc:content action="category" catid="0" order="lristorde ASC"  siteid="$siteid" num="11"}
                         {loop $data $v}
                            {if $v['catname']==东校区}
  ...
  <ul class="num" id="idNum">
    ...
    <li>3</li>
           	  ...
           	  <div id="news">
                   ...
                   <ul >
                      {pc:content action="category" catid="27" order="inputtime DESC" num="8" siteid="$siteid"}
                         {loop $data $v}
...
<!--                     <li><a href="content.html" class="hot">【家长学校1306期】大学主要的专业介绍</a><span class="newsdate">2013-05-10</span></li>
          ...
          <div id="notice">
            ...
            <ul>
                {pc:content action="category" catid="21" order="inputtime DESC" num="4" siteid="$siteid"}
                    {loop $data $v}
                        <li><a href="{$v['url']}" >{$v['title']}</a><span class="newsdate">{date('Y-m-d',$v['inputtime'])}</span></li>
                    {/loop}
                {/pc}
	  ...
	  <div id="no2">
        	<div class="news_content">
            	<h1><img src="{IMG_PATH}/hbschool/news_jy_title.gif" width="480" height="40" usemap="#Map" border="0" alt="教研网" />
                 ...
                 <ul>
                {pc:content action="lists" catid="12" order="inputtime DESC" num="4" siteid="$siteid"}
                    {loop $data $v}
                        <li><a href="{$v['url']}" >{$v['title']}</a><span class="newsdate">{date('Y-m-d',$v['inputtime'])}</span></li>
                    {/loop}
                {/pc}
<!--                 	<li><a href="#">[公开课教学][图文]化学老师于文英举办观摩课活动</a> </li> 
            ...
            <div class="news_content" style="margin-left:45px; _margin-left:25px">
                ...
                <ul>
                  {pc:content action="lists" catid="11" order="inputtime DESC" num="4" siteid="$siteid"}
                    {loop $data $v}
                        <li><a href="{$v['url']}" >{$v['title']}</a><span class="newsdate">{date('Y-m-d',$v['inputtime'])}</span></li>
                    {/loop}
                {/pc}
